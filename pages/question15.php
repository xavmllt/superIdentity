...
<head>
    ...
    <script src="../scripts/lastQuestion.js" defer></script>
    <title>Super Identity - Identity 15</title>
</head>
<body>
        ...
        <section>
            ...
            <div class="conteneur">
                ...
                <div class="reponse">
                    ...
                    <div id="rebelle" class="choix">Rebelle 😎</div>
                    <div id="other" class="choix">Moi-même 😀</div>
                </div>
            </div>
