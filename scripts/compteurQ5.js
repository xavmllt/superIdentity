...
function mettreAJourURL() {
    window.location.href = `../pages/question6.php?compteurBelle=${compteurBelle}&compteurBulle=${compteurBulle}&compteurRebelle=${compteurRebelle}&compteurOther=${compteurOther}`;
};
